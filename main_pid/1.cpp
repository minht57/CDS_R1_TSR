...
// int R2_H_max = 255;//5;
// int R2_S_val = 255;//90;
// int R2_S_max = 255;//255;
// int R2_V_val = 255;//60;
// int R2_V_max = 255;//255;
    ...
    while (1) {
     ...
     //   	Size kernalSize (5,5);
        ...
        for( int i = 0; i< contours.size(); i++ )
		{
			...
			{
				if (
					(((float)boundRect[i].width/boundRect[i].height) > 0.5) &&(((float)boundRect[i].width/boundRect[i].height) < 1.3))
				{
